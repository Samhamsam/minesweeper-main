...
public interface IController {
	...
	enum State {
		NEW_GAME, INFO_TEXT, REVEAL_CELL, TOGGLE_FLAG, HELP_TEXT, GAME_WON, GAME_LOST, ERROR, CHANGE_SETTINGS_ACTIVATED, CHANGE_SETTINGS_SUCCESS, LOAD_GAME, UPDATE, FIRST_START, EXIT_GAME
	}
